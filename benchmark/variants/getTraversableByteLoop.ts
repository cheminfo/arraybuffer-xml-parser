// Vendored copy of getTraversable for the A/B benchmark: steps one byte at a time looking for `<`
...
import type { RealParseOptions } from '../../src/traversable/defaultOptions.ts';
...
export function getTraversableByteLoop(
  xmlData: Uint8Array,
