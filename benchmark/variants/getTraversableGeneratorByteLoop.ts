// Vendored copy of getTraversableGenerator for the A/B benchmark: steps one byte at a time looking for `<`
...
export async function* getTraversableGeneratorByteLoop(
