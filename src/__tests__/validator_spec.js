...
describe('XMLParser', function () {
  ...
  it('should validate self closing tags', function () {
    validate(
      "<rootNode><validtag1  /><validtag2/><validtag3  with='attrib'/><validtag4 />text<validtag5/>text</rootNode>",
    );
  });

  it('should not consider these as self closing tags', function () {
    validate(
      "<rootNode><validtag1/><invalid tag/><validtag3  with='attrib'/></rootNode>",
      {
  ...
  it('should not validate xml string when closing tag is invalid', function () {
    ...
    validate('<rootNode></rootnode 123>', {
      InvalidTag:
        "Closing tag 'rootnode' can't have attributes or invalid starting.",
    });
  });
  ...
  it('should return false for invalid xml', function () {
    validateFile(
      ...
      {
        InvalidTag:
          "Closing tag 'selfclosing' is expected inplace of 'person'.",
      },
      27,
    );
  });
  ...
  it('should not validate XML with prolog only', function () {
    validate(
      '<?xml version="1.0" standalone="yes" ?><!--some comment -  end in this line-->',
      {
